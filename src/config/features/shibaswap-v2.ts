...
export const SHIBASWAP_V2_SUPPORTED_CHAIN_IDS = [
  EvmChainId.ARBITRUM,
...
export const ShibaSwapV2ChainIds = SHIBASWAP_V2_SUPPORTED_CHAIN_IDS;

export type ShibaSwapV2ChainId =
  (typeof SHIBASWAP_V2_SUPPORTED_CHAIN_IDS)[number];

export const isShibaSwapV2ChainId = (
  chainId: EvmChainId
): chainId is ShibaSwapV2ChainId =>
  SHIBASWAP_V2_SUPPORTED_CHAIN_IDS.includes(chainId as ShibaSwapV2ChainId);

export const SHIBASWAP_V2_INIT_CODE_HASH: Record<
  ShibaSwapV2ChainId,
  `0x${string}`
> = {
  [EvmChainId.ETHEREUM]:
...
export const SHIBASWAP_V2_FACTORY_ADDRESS: Record<
  ShibaSwapV2ChainId,
  `0x${string}`
> = {
...
export const SHIBASWAP_V2_ROUTER_ADDRESS: Record<
  ShibaSwapV2ChainId,
  `0x${string}`
> = {
