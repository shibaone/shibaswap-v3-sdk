...
export enum ShibaSwapV3FeeAmount {
  /** 0.01% */
  LOWEST = 100,
  /** 0.1% */
  LOW = 500,
 ...
 */
export const TICK_SPACINGS: { [_amount in ShibaSwapV3FeeAmount]: number } = {
  [ShibaSwapV3FeeAmount.LOWEST]: 1,
  [ShibaSwapV3FeeAmount.LOW]: 10,
  [ShibaSwapV3FeeAmount.MEDIUM]: 60,
  [ShibaSwapV3FeeAmount.HIGH]: 200,
};

// SHIBASWAP
export const SHIBASWAP_V3_FACTORY_ADDRESS: Record<ShibaSwapV3ChainId, Address> =
  {
...
export type ShibaSwapV3ChainId =
  (typeof SHIBASWAP_V3_SUPPORTED_CHAIN_IDS)[number];

export const isShibaSwapV3ChainId = (
  chainId: EvmChainId
): chainId is ShibaSwapV3ChainId =>
  SHIBASWAP_V3_SUPPORTED_CHAIN_IDS.includes(chainId as ShibaSwapV3ChainId);
