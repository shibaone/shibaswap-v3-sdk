...
export const EVM_DEFAULT_BASES = {
  ...
  [EvmChainId.SHIBARIUM]: [
    ...
    new Token({
      chainId: EvmChainId.SHIBARIUM,
      address: LEASH_ADDRESS[EvmChainId.SHIBARIUM],
      decimals: 18,
      symbol: "LEASH",
      name: "Doge Killer",
    }),
    new Token({
      chainId: EvmChainId.SHIBARIUM,
      address: TREAT_ADDRESS[EvmChainId.SHIBARIUM],
      decimals: 18,
      symbol: "TREAT",
      name: "Treat",
    }),
  ...
  [EvmChainId.PUPPYNET]: [
    ...
    new Token({
      chainId: EvmChainId.PUPPYNET,
      address: LEASH_ADDRESS[EvmChainId.PUPPYNET],
      decimals: 18,
      symbol: "LEASH",
      name: "Doge Killer",
    }),
    new Token({
      chainId: EvmChainId.PUPPYNET,
      address: TREAT_ADDRESS[EvmChainId.PUPPYNET],
      decimals: 18,
      symbol: "TREAT",
      name: "Treat",
    }),
