...
export const EVM_DEFAULT_BASES = {
  [EvmChainId.ETHEREUM]: [
    ...
    BONE[EvmChainId.ETHEREUM],
    TREAT[EvmChainId.ETHEREUM],
    SHIB[EvmChainId.ETHEREUM],
    LEASH[EvmChainId.ETHEREUM],
  ...
  [EvmChainId.SHIBARIUM]: [
    Native.onChain(EvmChainId.SHIBARIUM),
    WNATIVE[EvmChainId.SHIBARIUM],
    USDC[EvmChainId.SHIBARIUM],
    USDT[EvmChainId.SHIBARIUM],
    DAI[EvmChainId.SHIBARIUM],
    SHIB[EvmChainId.SHIBARIUM],
    LEASH[EvmChainId.SHIBARIUM],
    TREAT[EvmChainId.SHIBARIUM],
  ],
  [EvmChainId.PUPPYNET]: [
    Native.onChain(EvmChainId.PUPPYNET),
    WNATIVE[EvmChainId.PUPPYNET],
    USDC[EvmChainId.PUPPYNET],
    USDT[EvmChainId.PUPPYNET],
    DAI[EvmChainId.PUPPYNET],
    SHIB[EvmChainId.PUPPYNET],
    LEASH[EvmChainId.PUPPYNET],
    TREAT[EvmChainId.PUPPYNET],
  ],
