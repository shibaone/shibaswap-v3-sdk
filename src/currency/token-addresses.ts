...
export const WETH9_ADDRESS = {
  ...
  // [EvmChainId.BASE_TESTNET]: "0x4200000000000000000000000000000000000006",
  // [EvmChainId.BASE_SEPOLIA]: "0x4200000000000000000000000000000000000006",
  ...
  [EvmChainId.SHIBARIUM]: "0x8ed7d143Ef452316Ab1123d28Ab302dC3b80d3ce",
  [EvmChainId.PUPPYNET]: "0x0C477AE2E8E5ce1666468e44b066542Fa46f9F72",
} as const;
...
export const WNATIVE_ADDRESS = {
  ...
  // [EvmChainId.BASE_TESTNET]: WETH9_ADDRESS[EvmChainId.BASE_TESTNET],
  // [EvmChainId.BASE_SEPOLIA]: WETH9_ADDRESS[EvmChainId.BASE_SEPOLIA],
  ...
  [EvmChainId.SHIBARIUM]: WETH9_ADDRESS[EvmChainId.SHIBARIUM],
  [EvmChainId.PUPPYNET]: WETH9_ADDRESS[EvmChainId.PUPPYNET],
  // Removing duplicate entries below
  // [EvmChainId.HEMI]: WETH9_ADDRESS[EvmChainId.HEMI],
  // [EvmChainId.SHIBARIUM]: WETH9_ADDRESS[EvmChainId.SHIBARIUM],
  // [EvmChainId.PUPPYNET]: WETH9_ADDRESS[EvmChainId.PUPPYNET],
} as const;
...
export const USDC_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0xf010f12dcA0b96D2d6685bf4dB3dbB4Ad500B6Ad",
  [EvmChainId.PUPPYNET]: "0x63E22542204dA9978218FbB3C10E1c0f6D1DC2a7",
} as const;
...
export const USDT_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0xaB082b8ad96c7f47ED70ED971Ce2116469954cFB",
  [EvmChainId.SEPOLIA]: "0x7169d38820dfd117c3fa1f22a697dba58d90ba06",
  [EvmChainId.PUPPYNET]: "0x236a6f60B554813486D84d581747217d77Af05ff",
} as const;
...
export const DAI_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0x0726959d22361B79e4D50A5D157b044A83eC870d",
  [EvmChainId.SEPOLIA]: "0x090d346d1662313F97D2072CF63c21409f2C848C",
  [EvmChainId.PUPPYNET]: "0x12CF8bf22Be843f8c065a2474d1C439daDD238b6",
} as const;
...
export const MIM_ADDRESS = {
  ...
  [EvmChainId.BASE]: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913",
  [EvmChainId.SCROLL]: "0x06eFdBFf2a14a7c8E15944D1F4A48F9F95F663A4",
  //[EvmChainId.FILECOIN]: axlUSDT_ADDRESS[EvmChainId.FILECOIN],
  [EvmChainId.ZETACHAIN]: "0x0cbe0dF132a6c6B4a2974Fa1b7Fb953CF0Cc798a",
  [EvmChainId.CRONOS]: "0xc21223249CA28397B4B6541dfFaEcC539BfF0c59",
  [EvmChainId.SKALE_EUROPA]: "0x5F795bb52dAC3085f578f4877D450e2929D2F13d",
  [EvmChainId.ROOTSTOCK]: "0x1BDA44fda023f2aF8280A16FD1b01d1a493BA6C4",
  ...
  [EvmChainId.SONIC]: "0x29219dd400f2Bf60E5a23d13Be72B486D4038894",
  [EvmChainId.HEMI]: "0xad11a8BEb98bbf61dbb1aa0F6d6F2ECD87b35afA",
  [EvmChainId.SHIBARIUM]: "0xad11a8BEb98bbf61dbb1aa0F6d6F2ECD87b35afA",
  [EvmChainId.PUPPYNET]: "0xad11a8BEb98bbf61dbb1aa0F6d6F2ECD87b35afA",
} as const;
...
export const FRAX_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0xAb2AF3A98D229b7dAeD7305Bb88aD0BA2c42f9cA",
  [EvmChainId.PUPPYNET]: "0xAb2AF3A98D229b7dAeD7305Bb88aD0BA2c42f9cA",
} as const;
...
export const FXS_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0xdc1664458d2f0B6090bEa60A8793A4E66c2F1c00",
  [EvmChainId.PUPPYNET]: "0xdc1664458d2f0B6090bEa60A8793A4E66c2F1c00",
} as const;
...
export const AGEUR_ADDRESS = {
  ...
  [EvmChainId.SHIBARIUM]: "0xC16B81Af351BA9e64C1a069E3Ab18c244A1E3049",
  [EvmChainId.PUPPYNET]: "0xC16B81Af351BA9e64C1a069E3Ab18c244A1E3049",
} as const;
...
export const BONE_ADDRESS = {
  [EvmChainId.SHIBARIUM]: "0x0000000000000000000000000000000000001010",
  [EvmChainId.PUPPYNET]: "0x0000000000000000000000000000000000001010",
  [EvmChainId.ETHEREUM]: "0x9813037ee2218799597d83D4a5B6F3b6778218d9",
} as const;

export const SHIB_ADDRESS = {
  [EvmChainId.SHIBARIUM]: "0x495eea66B0f8b636D441dC6a98d8F5C3D455C4c0",
  [EvmChainId.PUPPYNET]: "0xAc720702Df63fa92416B3dEB24Dc4a1854f73330",
  [EvmChainId.ETHEREUM]: "0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE",
} as const;

export const LEASH_ADDRESS = {
  [EvmChainId.SHIBARIUM]: "0x65218A41Fb92637254B4f8c97448d3dF343A3064",
  [EvmChainId.PUPPYNET]: "0x367a6722F2e2b09b6024A1C05deAD45e68CE385A",
  [EvmChainId.ETHEREUM]: "0x27C70Cd1946795B66be9d954418546998b546634",
} as const;

export const TREAT_ADDRESS = {
  [EvmChainId.SHIBARIUM]: "0x506d8d2d9c715Eb34F514cc3EF48C7aBD19e2bc7",
  [EvmChainId.PUPPYNET]: "0x8282aC2718273282117ea7294CDb1143C6aCA19A",
  [EvmChainId.ETHEREUM]: "0xa02C49Da76A085e4E1EE60A6b920dDbC8db599F4",
} as const;
