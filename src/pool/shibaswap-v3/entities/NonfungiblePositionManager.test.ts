...
} from "~shibaswap-v3-sdk/abi/index.js";
...
describe("NonfungiblePositionManager", () => {
  ...
  const fee = ShibaSwapV3FeeAmount.MEDIUM;

  const pool_0_1 = new ShibaSwapV3Pool(
    token0,
    token1,
    fee,
  ...
  const pool_1_weth = new ShibaSwapV3Pool(
    token1,
    WETH9[1],
    fee,
    encodeSqrtRatioX96(1, 1),
  ...
  describe("#addCallParameters", () => {
    it("throws if liquidity is 0", () => {
      expect(() =>
        NonfungiblePositionManager.addCallParameters(
          new Position({
            pool: pool_0_1,
            tickLower: -TICK_SPACINGS[ShibaSwapV3FeeAmount.MEDIUM],
            tickUpper: TICK_SPACINGS[ShibaSwapV3FeeAmount.MEDIUM],
            liquidity: 0n,
          }),
    ...
    it("succeeds for mint", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
      expect(value).toEqual("0x00");
    });
    ...
    it("succeeds for increase", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
      expect(value).toEqual("0x00");
    });
    ...
    it("createPool", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
      expect(value).toEqual("0x00");
    });
    ...
    it("useNative", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
  ...
  describe("#removeCallParameters", () => {
    ...
    it("works", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
      expect(value).toEqual("0x00");
    });
    ...
    it("works for partial", () => {
      ...
      expect(calldata).toEqual(
        ""
      );
      expect(value).toEqual("0x00");
    });
