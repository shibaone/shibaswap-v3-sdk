...
describe("ShibaSwapV3Pool", () => {
    ...
    it("fee must be integer", () => {
      expect(() => {
        new ShibaSwapV3Pool(
          USDC,
          WETH9[1],
          ShibaSwapV3FeeAmount.MEDIUM + 0.5,
          encodeSqrtRatioX96(1, 1),
          0,
          0,
          []
  ...
  describe("#getAddress", () => {
    it("matches an example", () => {
      const result = ShibaSwapV3Pool.getAddress(
        USDC,
        DAI,
        ShibaSwapV3FeeAmount.LOW
      );
  ...
  describe("#priceOf", () => {
    const pool = new ShibaSwapV3Pool(
      USDC,
      DAI,
      ShibaSwapV3FeeAmount.LOW,
      encodeSqrtRatioX96(1, 1),
        ...
        [
          {
            index: nearestUsableTick(
              TickMath.MIN_TICK,
              TICK_SPACINGS[ShibaSwapV3FeeAmount.LOW]
            ),
