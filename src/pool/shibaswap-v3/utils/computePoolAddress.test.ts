...
import { ShibaSwapV3FeeAmount } from "../../../config/index.js";
import { Token } from "../../../currency/index.js";
import { computeShibaSwapV3PoolAddress } from "./computePoolAddress.js";
...
describe("#computePoolAddress", () => {
  ...
  it("should correctly compute the pool address", () => {
    ...
    const result = computeShibaSwapV3PoolAddress({
      factoryAddress,
      fee: ShibaSwapV3FeeAmount.LOW,
      tokenA,
      tokenB,
    });
  ...
  it("should correctly compute the pool address", () => {
    ...
    let tokenA = USDC;
    let tokenB = DAI;
    const resultA = computeShibaSwapV3PoolAddress({
      factoryAddress,
      fee: ShibaSwapV3FeeAmount.LOW,
      tokenA,
      tokenB,
    ...
    tokenB = USDC;
    const resultB = computeShibaSwapV3PoolAddress({
      factoryAddress,
      fee: ShibaSwapV3FeeAmount.LOW,
      tokenA,
      tokenB,
  ...
  it("BLAST - should correctly compute the pool address", () => {
    ...
    const result = computeShibaSwapV3PoolAddress({
      ...
      fee: ShibaSwapV3FeeAmount.MEDIUM,
      tokenA,
      tokenB,
    });
